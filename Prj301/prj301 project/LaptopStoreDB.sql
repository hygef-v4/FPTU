USE [master]
GO
/****** Object:  Database [LaptopStore2]    Script Date: 03/26/25 12:04:56 PM ******/
...
GO
/****** Object:  Table [dbo].[tblCategories]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblDiscounts]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrderDetails]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblOrders]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductDetails]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProducts]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblProductViews]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblReviews]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblRoles]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblShipping]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblUsers]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tblWishlist]    Script Date: 03/26/25 12:04:56 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (53, 1, 2, 44, 20990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (54, 2, 5, 44, 25990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (56, 1, 4, 46, 21990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (57, 1, 6, 47, 32990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (58, 3, 5, 47, 25990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (59, 1, 2, 48, 20990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (60, 1, 3, 48, 22990000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (61, 1, 1, 49, 16490000)
GO
INSERT [dbo].[tblOrderDetails] ([detailID], [quantity], [productID], [orderID], [price]) VALUES (62, 1, 3, 49, 22990000)
GO
SET IDENTITY_INSERT [dbo].[tblOrderDetails] OFF
GO
SET IDENTITY_INSERT [dbo].[tblOrders] ON 
GO
INSERT [dbo].[tblOrders] ([orderID], [amount], [userID], [orderDate], [fullName], [address], [phone], [note], [status]) VALUES (44, 72970000, 2, CAST(N'2025-03-25T23:23:04.013' AS DateTime), N'Khuất Quang Hưng', N'FPT, Thạch Thất, Hà Nội, Việt Nam', N'0327715098', N'không có ghi chú', 1)
GO
INSERT [dbo].[tblOrders] ([orderID], [amount], [userID], [orderDate], [fullName], [address], [phone], [note], [status]) VALUES (46, 21990000, 2, CAST(N'2025-03-26T07:40:56.807' AS DateTime), N'Khuất Quang Hưng', N'FPT, Thạch Thất, Hà Nội, Việt Nam', N'0327715098', N'không có ghi chú', 1)
GO
INSERT [dbo].[tblOrders] ([orderID], [amount], [userID], [orderDate], [fullName], [address], [phone], [note], [status]) VALUES (47, 110960000, 2, CAST(N'2025-03-26T07:49:45.283' AS DateTime), N'Khuất Quang Hưng', N'FPT, Thạch Thất, Hà Nội, Việt Nam', N'0327715098', N'không có ghi chú', 1)
GO
INSERT [dbo].[tblOrders] ([orderID], [amount], [userID], [orderDate], [fullName], [address], [phone], [note], [status]) VALUES (48, 43980000, 1, CAST(N'2025-03-26T08:30:17.990' AS DateTime), N'Quang Hưng', N'Hà Nội việt nam', N'0123456789', N'không có ghi chú', 1)
GO
INSERT [dbo].[tblOrders] ([orderID], [amount], [userID], [orderDate], [fullName], [address], [phone], [note], [status]) VALUES (49, 39480000, 2, CAST(N'2025-03-26T09:07:42.437' AS DateTime), N'Khuất Quang Hưng', N'FPT, Thạch Thất, Hà Nội, Việt Nam', N'0327715098', N'không có ghi chú', 0)
GO
...
GO
INSERT [dbo].[tblProductDetails] ([detailID], [productID], [cpu], [ram], [storage], [screen], [gpu]) VALUES (48, 51, N'core i7', N'12gb', N'521gb', N'lcd 26 inch', N'nvidia rtx 4060')
GO
INSERT [dbo].[tblProductDetails] ([detailID], [productID], [cpu], [ram], [storage], [screen], [gpu]) VALUES (49, 52, N'core i7', N'4gb', N'256gb ', N'lcd 26 inch', N'nvidia rtx 4060')
GO
SET IDENTITY_INSERT [dbo].[tblProductDetails] OFF
GO
SET IDENTITY_INSERT [dbo].[tblProducts] ON 
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (1, N'MSI Katana GF66', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_10_19_638017841585071699_msi-gaming-katana-gf66-12u-den-1.jpg', 16490000, 9, N'C001', N'B007', CAST(N'2023-03-15' AS Date), 12, 1, N'Laptop gaming với CPU và GPU mạnh, màn hình tần số quét cao, hỗ trợ chơi game nặng mượt mà.')
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (2, N'Acer Nitro 5', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2021_7_5_637610884165519217_acer-nitro-gaming-an515-57-den-1.jpg', 20990000, 20, N'C001', N'B005', CAST(N'2023-05-10' AS Date), 12, 1, N'Laptop gaming với CPU và GPU mạnh, màn hình tần số quét cao, hỗ trợ chơi game nặng mượt mà.')
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (3, N'Asus TUF Gaming F15', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2023_7_4_638240754677083179_asus-tuf-gaming-fx507-xam-1.jpg', 22990000, 19, N'C001', N'B002', CAST(N'2023-06-18' AS Date), 12, 1, N'Laptop gaming với CPU và GPU mạnh, màn hình tần số quét cao, hỗ trợ chơi game nặng mượt mà.')
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (4, N'Dell G15', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_4_21_637861309658938216_dell-gaming-g15-5515-xam-1.jpg', 21990000, 19, N'C001', N'B003', CAST(N'2023-07-25' AS Date), 12, 1, N'Laptop gaming với CPU và GPU mạnh, màn hình tần số quét cao, hỗ trợ chơi game nặng mượt mà.')
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (10, N'Asus ExpertBook B9', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_10_26_638023821244393375_asus-expertbook-b5302-den-1.jpg', 27990000, 21, N'C002', N'B002', CAST(N'2023-07-15' AS Date), 12, 0, N'Laptop văn phòng gọn nhẹ, thời lượng pin dài, bàn phím êm, phù hợp làm việc và học tập.')
GO
...
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (28, N'MacBook Pro 16', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/macbook_pro_16_m4_pro_max_silver_1_6f38aaf8d8.png', 55990000, 18, N'C005', N'B006', CAST(N'2023-10-01' AS Date), 12, 1, N'Laptop cao cấp với thiết kế tinh tế, hiệu suất mạnh mẽ, màn hình chất lượng cao dành cho doanh nhân.')
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (51, N'Test', N'https://cdn.tgdd.vn/Products/Images/44/328131/lenovo-thinkpad-e16-ultra-7-21ma004pvn-1-750x500.jpg', 11000000, 7, N'C003', N'B003', CAST(N'2025-03-26' AS Date), 12, 0, N'Máy xịn')
GO
INSERT [dbo].[tblProducts] ([productID], [productName], [image], [price], [quantity], [categoryID], [brandID], [importDate], [warrantyMonths], [isFeatured], [description]) VALUES (52, N'Lenovo E140 Celeron N4120', N'https://cdn2.fptshop.com.vn/unsafe/750x0/filters:quality(100)/2022_3_18_637832265280921809_masstel-e140-celeron-n4120-xam-1.jpg', 4400000, 4, N'C003', N'B001', CAST(N'2023-03-15' AS Date), 12, 0, N'')
GO
...
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (1, N'Quang Hưng', N'admin', N'admin', 1, N'Hà Nội việt nam', N'0123456789', N'akira72005@gmail.com', 1)
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (2, N'Khuất Quang Hưng', N'user2', N'Hunghehe123', 2, N'FPT, Thạch Thất, Hà Nội, Việt Nam', N'0327715098', N'hungsct1702@gmail.com', 1)
GO
...
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (5, N'Phạm Văn E', N'user5', N'123', 2, N'Thạch Thất, Hà Nội', N'0956789012', N'e@example.com', 1)
GO
...
GO
INSERT [dbo].[tblUsers] ([userID], [fullName], [username], [password], [roleID], [address], [phone], [email], [activate]) VALUES (16, N'Hải Nam', N'user789', N'Hunghehe123', 2, N'Thạch Thất, Hà Nội', N'0371182384', N'hainam123@gmail.com', 1)
GO
SET IDENTITY_INSERT [dbo].[tblUsers] OFF
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblDisco__357D4CF924684122]    Script Date: 03/26/25 12:04:56 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__tblDisco__357D4CF9B9DED8E0]    Script Date: 03/26/25 12:04:56 PM ******/
ALTER TABLE [dbo].[tblDiscounts] ADD UNIQUE NONCLUSTERED 
(
	[code] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[tblOrders] ADD  CONSTRAINT [DF__tblOrders__statu__607251E5]  DEFAULT ((0)) FOR [status]
GO
