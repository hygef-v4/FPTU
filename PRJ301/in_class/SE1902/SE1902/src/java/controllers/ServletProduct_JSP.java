    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (service.equals("updateProduct")) {
            ...
            if (submit == null) { // show ra UpdateProduct.jsp
                ...
                request.getRequestDispatcher("jsp/UpdateProduct_JSTL.jsp").forward(request, response);
...
//Set data for view
                request.setAttribute("vector", vector);
                //select view
                request.getRequestDispatcher("jsp/InsertProduct_JSTL.jsp").forward(request, response);
            } else {
                String productName = request.getParameter("productName"),
                        image = request.getParameter("image");
                double price = Double.parseDouble(request.getParameter("price"));
